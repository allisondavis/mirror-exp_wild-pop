...
hist2 <- ggplot(rawextra2, aes(x=LI.TOT)) + geom_histogram(color="black", fill="white") + facet_grid(X.U.FEFF.SPP ~ .) + geom_vline(data = mu2, aes(xintercept=grp.mean, color="red"), linetype="dashed")
