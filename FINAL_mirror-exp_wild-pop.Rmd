...
rem_out3 <- ggplot(RAWEXTRA, aes(x=X.U.FEFF.SPP, y=LI.TOT)) + geom_boxplot(coef=3) + geom_point(color="gray75", size=2, alpha=0.5) + scale_y_continuous(breaks = seq(-15, 30, 15)) +  coord_cartesian(ylim = c(-15, 30))  + ylab("Laterality index") + xlab("") +theme_classic()
...
LATeye2 <- ggplot(LAT_tankextraP, aes(x=TANK, y=LI.TOT))+ geom_boxplot(coef=3) + geom_point(color="gray75", size=2, alpha=0.5) + scale_y_continuous(breaks = seq(-30, 30, 10)) +  coord_cartesian(ylim = c(-30, 30)) + xlab("Tanks") + ylab("Laterality index") + ggtitle("Sailfin eye use") + theme_classic()
